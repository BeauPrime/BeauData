...
namespace BeauData
{
    public abstract partial class Serializer
    {
        ...
        {
            DoStruct<UnityEngine.RectInt>(inKey, ref ioData, inOptions, Serialize_RectInt);
        }
        ...
        {
            DoStruct<UnityEngine.RectInt>(inKey, ref ioData, inDefault, inOptions, Serialize_RectInt);
        }

        public void Array(string inKey, ref List<UnityEngine.RectInt> ioArray, FieldOptions inOptions = FieldOptions.None)
        {
            DoStructArray<UnityEngine.RectInt>(inKey, ref ioArray, inOptions, Serialize_RectInt);
        }
        ...
        {
            DoStructSet<UnityEngine.RectInt>(inKey, ref ioSet, inOptions, Serialize_RectInt);
        }

        public void Map(string inKey, ref Dictionary<string, UnityEngine.RectInt> ioMap, FieldOptions inOptions = FieldOptions.None)
        {
            DoStructMap<UnityEngine.RectInt>(inKey, ref ioMap, inOptions, Serialize_RectInt);
        }
