...
namespace BeauData
{
    public abstract partial class Serializer
    {
        ...
        {
            DoStruct<UnityEngine.Vector2>(inKey, ref ioData, inOptions, Serialize_Vector2);
        }
        ...
        {
            DoStruct<UnityEngine.Vector2>(inKey, ref ioData, inDefault, inOptions, Serialize_Vector2);
        }

        public void Array(string inKey, ref List<UnityEngine.Vector2> ioArray, FieldOptions inOptions = FieldOptions.None)
        {
            DoStructArray<UnityEngine.Vector2>(inKey, ref ioArray, inOptions, Serialize_Vector2);
        }
        ...
        {
            DoStructSet<UnityEngine.Vector2>(inKey, ref ioSet, inOptions, Serialize_Vector2);
        }

        public void Map(string inKey, ref Dictionary<string, UnityEngine.Vector2> ioMap, FieldOptions inOptions = FieldOptions.None)
        {
            DoStructMap<UnityEngine.Vector2>(inKey, ref ioMap, inOptions, Serialize_Vector2);
        }
