...
using SerializedType = UnityEngine.Vector2;

namespace BeauData
{
    public abstract partial class Serializer
    {
        static private void Serialize_Vector2(ref SerializedType ioData, Serializer ioSerializer)
        {
        ...
        {
            DoStruct<SerializedType>(inKey, ref ioData, inOptions, Serialize_Vector2);
        }
        ...
        {
            DoStruct<SerializedType>(inKey, ref ioData, inDefault, inOptions, Serialize_Vector2);
        }

        public void Array(string inKey, ref List<SerializedType> ioArray, FieldOptions inOptions = FieldOptions.None)
        {
            DoStructArray<SerializedType>(inKey, ref ioArray, inOptions, Serialize_Vector2);
        }
        ...
        {
            DoStructSet<SerializedType>(inKey, ref ioSet, inOptions, Serialize_Vector2);
        }

        public void Map(string inKey, ref Dictionary<string, SerializedType> ioMap, FieldOptions inOptions = FieldOptions.None)
        {
            DoStructMap<SerializedType>(inKey, ref ioMap, inOptions, Serialize_Vector2);
        }
