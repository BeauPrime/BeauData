...
namespace BeauData
{
    ...
    {
        static private TypeUtility.TypeSerializerDelegate<UnityEngine.Quaternion> Serialize_Quaternion_Cached;
        ...
        {
            DoStruct<UnityEngine.Quaternion>(inKey, ref ioData, inDefault, inOptions,
                Serialize_Quaternion_Cached ?? (Serialize_Quaternion_Cached = Serialize_Quaternion));
        }
