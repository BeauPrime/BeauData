...
namespace BeauData
{
    ...
    {
        static private TypeUtility.TypeSerializerDelegate<UnityEngine.BoundsInt> Serialize_BoundsInt_Cached;
        ...
        {
            DoStruct<UnityEngine.BoundsInt>(inKey, ref ioData, inDefault, inOptions,
                Serialize_BoundsInt_Cached ?? (Serialize_BoundsInt_Cached = Serialize_BoundsInt));
        }
