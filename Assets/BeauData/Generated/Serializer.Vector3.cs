...
namespace BeauData
{
    public abstract partial class Serializer
    {
        ...
        {
            DoStruct<UnityEngine.Vector3>(inKey, ref ioData, inOptions, Serialize_Vector3);
        }
        ...
        {
            DoStruct<UnityEngine.Vector3>(inKey, ref ioData, inDefault, inOptions, Serialize_Vector3);
        }

        public void Array(string inKey, ref List<UnityEngine.Vector3> ioArray, FieldOptions inOptions = FieldOptions.None)
        {
            DoStructArray<UnityEngine.Vector3>(inKey, ref ioArray, inOptions, Serialize_Vector3);
        }
        ...
        {
            DoStructSet<UnityEngine.Vector3>(inKey, ref ioSet, inOptions, Serialize_Vector3);
        }

        public void Map(string inKey, ref Dictionary<string, UnityEngine.Vector3> ioMap, FieldOptions inOptions = FieldOptions.None)
        {
            DoStructMap<UnityEngine.Vector3>(inKey, ref ioMap, inOptions, Serialize_Vector3);
        }
